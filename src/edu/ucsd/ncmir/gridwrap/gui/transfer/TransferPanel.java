	...
	public TransferPanel(int transferSize){
	  ...
	  gbc.insets = new Insets(0,0,0,0);
		...
		if(transferSize < MAX_TRANSFER_DISPLAY){
			scrollPane.setPreferredSize(new Dimension(WIDTH,(transferSize)*HEIGHT));
			System.out.println("scrollpane size:"+(transferSize)*HEIGHT);
		}else{
			scrollPane.setPreferredSize(new Dimension(WIDTH,(MAX_TRANSFER_DISPLAY)*HEIGHT));
			System.out.println("scrollpane size:"+(MAX_TRANSFER_DISPLAY)*HEIGHT);
		}
